...
CREATE TABLE `adobe_express_etsy_plus_url_audits` (
  ...
  `adobe_express_url` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'A unique code that can be used to redeem Adobe Express for free for the promotional period',
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'Soft delete field. 0 = not soft deleted',
  ...
  `create_date` int unsigned NOT NULL DEFAULT '0',
  `update_date` int unsigned NOT NULL DEFAULT '0',
  `is_test_link` int unsigned NOT NULL DEFAULT '0' COMMENT 'Flag that can be thought of as "is_real". To enable testing without impacting real paid license distribution, we include a flag',
  ...
  KEY `is_test_idx` (`is_test_link`),
  KEY `adobe_express_url_idx` (`adobe_express_url`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;
...
CREATE TABLE `usps_data_feed_item_transaction_outbound` (
  `data_feed_id` bigint unsigned NOT NULL,
  `data_feed_item_id` bigint unsigned NOT NULL,
  `eps_transaction_id` bigint unsigned NOT NULL DEFAULT '0',
  `state` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'The state of the data feed item (indexed, processed, etc).',
  ...
  `extra_service_1_sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `extra_service_1_postage_amount` decimal(11,4) NOT NULL DEFAULT '0.0000',
  `extra_service_2_sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `extra_service_2_postage_amount` decimal(11,4) NOT NULL DEFAULT '0.0000',
  `extra_service_3_sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `extra_service_3_postage_amount` decimal(11,4) NOT NULL DEFAULT '0.0000',
  `extra_service_4_sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `extra_service_4_postage_amount` decimal(11,4) NOT NULL DEFAULT '0.0000',
  `extra_service_5_sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `extra_service_5_postage_amount` decimal(11,4) NOT NULL DEFAULT '0.0000',
  `electronic_file_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `manifest_package_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `assessment_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `monthly_adjustment_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `adjustment_details` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `admin_fee_amount` decimal(11,4) NOT NULL DEFAULT '0.0000',
  `permit_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `permit_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `permit_finance_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `unmanifested_packages` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `total_packages` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `unmanifested_ratio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `unmanifested_per_piece_fee` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `mailer_review_request_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `manifest_transaction_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `customer_reference_1` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Shipping Label ID we provide to USPS',
  `customer_reference_2` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Shop ID we provide to USPS',
  `etsy_calculated_rate_delta` int NOT NULL DEFAULT '0' COMMENT 'Internal use only. Calculated by us if there is a mismatch between expected and actual rates.',
  `anomaly_reason` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Internal use only. Description of why the item is in an anomalous state, if relevant.',
