CREATE DATABASE etsy_payments_shard_002_0_A;
USE etsy_payments_shard_002_0_A;
...
CREATE TABLE `bank_account_verification_tracker_log` (
  ...
  `event_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Additional information related to event (error code, webhook_code, etc…)',
